...
from app.api.endpoints import auth, users, products, reports, groups, clusters, assignments, categories, revisions, notifications, transfers, rejections, accountant_assignments, sold_products_stats, cities, user_category_rates
...
app.include_router(user_category_rates.router, prefix="/api")
