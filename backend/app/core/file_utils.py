...
def save_uploaded_files(files: List[UploadFile], folder_path: str) -> List[str]:
    """Сохранить загруженные файлы в указанную папку"""
    saved_paths = []
...
def save_revision_files(files: List[UploadFile], revision_id: str) -> List[str]:
    """Сохранить файлы ревизии"""
    saved_paths = []
    ...
    for file in files:
        if file.filename:
            ...
            try:
                ...
                print(f"Ошибка сохранения файла ревизии {file.filename}: {e}")
