...
const queryClient = new QueryClient({
  defaultOptions: {
    queries: {
      staleTime: 0, // Данные считаются устаревшими сразу после получения
      gcTime: 5 * 60 * 1000, // Кеш хранится 5 минут (в новой версии React Query вместо cacheTime)
    ...
    mutations: {
      retry: 1, // Мутации тоже можно повторять
    },
  },
});
  ...
  return (
    <ThemeProvider theme={theme}>
      ...
      <QueryClientProvider client={queryClient}>
        ...
        {/* Инструменты разработчика React Query - показываются только в режиме разработки */}
      </QueryClientProvider>
    </ThemeProvider>
  );
}
